...
function (a) {
  ...
  function d(a, b) {
    ...
    function i(i) {
      i.each(function () {
        function i(a) {
          var b = n(a) + s;
          return C[0] < b && b < C[1] ? p : 0
        }
        var k, l, t, u = a.select(this),
         v = this.__chart__ || n,
         w = this.__chart__ = g(),
         x = r ? r : f(w),
         y = u.selectAll(".tick").data(x, w),
         z = y.enter().insert("g", ".domain").attr("class", "tick").style("opacity", 1e-6),
         A = y.exit().remove(),
         B = a.transition(y).style("opacity", 1),
         C = n.rangeExtent ? n.rangeExtent() : e(n.range()),
         D = u.selectAll(".domain").data([0]),
         E = (D.enter().append("path").attr("class", "domain"), a.transition(D));
        z.append("line"), z.append("text");
        var F = z.select("line"),
         G = B.select("line"),
         H = y.select("text").text(h),
         I = z.select("text"),
         J = B.select("text");
        switch (b.isCategory ? (s = Math.ceil((w(1) - w(0)) / 2), l = m ? 0 : s, t = m ? s : 0) : s = l = 0, o) {
        case "bottom":
          k = c, F.attr("y2", p), I.attr("y", Math.max(p, 0) + q), G.attr("x1", l).attr("x2", l).attr("y2", i), J.attr("x", 0).attr("y", Math.max(p, 0) + q), H.attr("dy", ".71em").style("text-anchor", "middle"), E.attr("d", "M" + C[0] + "," + j + "V0H" + C[1] + "V" + j);
          break;
        case "top":
          k = c, F.attr("y2", -p), I.attr("y", -(Math.max(p, 0) + q)), G.attr("x2", 0).attr("y2", -p), J.attr("x", 0).attr("y", -(Math.max(p, 0) + q)), H.attr("dy", "0em").style("text-anchor", "middle"), E.attr("d", "M" + C[0] + "," + -j + "V0H" + C[1] + "V" + -j);
          break;
        case "left":
          k = d, F.attr("x2", -p), I.attr("x", -(Math.max(p, 0) + q)), G.attr("x2", -p).attr("y1", t).attr("y2", t), J.attr("x", -(Math.max(p, 0) + q)).attr("y", s), H.attr("dy", ".32em").style("text-anchor", "end"), E.attr("d", "M" + -j + "," + C[0] + "H0V" + C[1] + "H" + -j);
          break;
        case "right":
          k = d, F.attr("x2", p), I.attr("x", Math.max(p, 0) + q), G.attr("x2", p).attr("y2", 0), J.attr("x", Math.max(p, 0) + q).attr("y", 0), H.attr("dy", ".32em").style("text-anchor", "start"), E.attr("d", "M" + j + "," + C[0] + "H0V" + C[1] + "H" + j)
        }
        if (w.rangeBand) {
          var K = w,
           L = K.rangeBand() / 2;
        ...
        } else v.rangeBand ? v = w : A.call(k, w);
        z.call(k, v), B.call(k, w)
      })
    }
    var j, k, l, m, n = a.scale.linear(),
     o = "bottom",
     p = 6,
     q = 3,
     r = null,
     s = 0,
     t = !0;
    return b = b || {}, j = b.withOuterTick ? 6 : 0, i.scale = function (a) {
      return arguments.length ? (n = a, i) : n
    }, i.orient = function (a) {
      return arguments.length ? (o = a in {
        top: 1,
        right: 1,
        bottom: 1,
        left: 1
      ...
      return arguments.length ? (l = arguments, i) : l
  ...
  g.generate = function (a) {
    ...
    function () {}, x ||
    function () {}), B.mapToIds(B.data.targets).forEach(function (a) {
      B.withoutFadeIn[a] = !0
    }), B.updateZoom && B.updateZoom()
    ...
    return i(a.value) ? this.isScatterType(a) ? .5 : 1 : 0
        ...
        e.forEach(function (e) {
          if ("childList" === e.type && e.previousSibling) {
            ...
            var f = a.setInterval(function () {
              b.node().parentNode && (a.clearInterval(f), c.updateDimension(), c.config.oninit.call(c), c.redraw({
                withTransform: !0,
                withUpdateXDomain: !0,
                withUpdateOrgXDomain: !0,
                withTransition: !1,
    ...
    var b, c, d, e, f = this,
     g = f.config,
     h = a[1] - a[0];
    return f.isCategorized() ? c = 0 : f.hasType("bar") ? (b = f.getMaxDataCount(), c = b > 1 ? h / (b - 1) / 2 : .5) : c = .01 * h, "object" == typeof g.axis_x_padding && r(g.axis_x_padding) ? (d = i(g.axis_x_padding.left) ? g.axis_x_padding.left : c, e = i(g.axis_x_padding.right) ? g.axis_x_padding.right : c) : d = e = "number" == typeof g.axis_x_padding ? g.axis_x_padding : c, {
      left: d,
      right: e
    }
    ...
    a = a || h.eventRect.data(function (a) {
      ...
      return null === b && null === c ? i.axis_rotated ? h.height : h.width : 0 > e ? 0 : e
    }, g = function (a) {
      var b = h.getPrevX(a.index),
       c = h.getNextX(a.index),
       d = h.data.xs[a.id][a.index];
      return null === b && null === c ? 0 : (h.x(d) + h.x(b ? b : d)) / 2
    ...
    a.append("rect").attr("class", b.classEvent.bind(b)).style("cursor", d.data_selection_enabled && d.data_selection_grouped ? "pointer" : null).on("mouseover", function (a) {
      ...
      }), c = e.concat(c), d.point_focus_expand_enabled && b.expandCircles(f, null, !0), b.expandBars(f, null, !0), b.main.selectAll("." + h.shape + "-" + f).each(function (a) {
        d.data_onmouseover.call(b, a)
      }))
    }).on("mouseout", function (a) {
      var c = a.index;
      b.hasArcType() || (b.hideXGridFocus(), b.hideTooltip(), b.unexpandCircles(), b.unexpandBars(), b.main.selectAll("." + h.shape + "-" + c).each(function (a) {
        d.data_onmouseout.call(b, a)
      }))
    }).on("mousemove", function (a) {
      var e, f = a.index,
       g = b.svg.select("." + h.eventRect + "-" + f);
      b.dragging || b.flowing || b.hasArcType() || (b.isStepType(a) && c.mouse(this)[0] < b.x(b.getXValue(a.id, f)) && (f -= 1), e = b.filterTargetsToShow(b.data.targets).map(function (a) {
        return b.addName(b.getValueOnIndex(a.values, f))
      ...
      if (!b.hasArcType() && b.toggleShape) {
        ...
        b.isStepType(a) && c.mouse(this)[0] < b.x(b.getXValue(a.id, e)) && (e -= 1), b.main.selectAll("." + h.shape + "-" + e).each(function (a) {
    ...
    a.append("rect").attr("x", 0).attr("y", 0).attr("width", b.width).attr("height", b.height).attr("class", h.eventRect).on("mouseout", function () {
      ...
      b.dragging || b.hasArcType(i) || (a = c.mouse(this), e = b.findClosestFromTargets(i, a), e && (f = b.isScatterType(e) ? [e] : b.filterByX(i, e.x), g = f.map(function (a) {
        return b.addName(a)
      ...
      var a, e, f = b.filterTargetsToShow(b.data.targets);
      b.hasArcType(f) || (a = c.mouse(this), e = b.findClosestFromTargets(f, a), e && b.dist(e, a) < 100 && b.toggleShape && b.main.select("." + h.circles + b.getTargetSelectorSuffix(e.id)).select("." + h.circle + "-" + e.index).each(function () {
        (d.data_selection_grouped || b.isWithinShape(this, e)) && (b.toggleShape(this, e, e.index), b.config.data_onclick.call(b.api, e, this))
      }))
    }).call(c.behavior.drag().origin(Object).on("drag", function () {
      b.drag(c.mouse(this))
    }).on("dragstart", function () {
    ...
    var c, d = this,
     e = d.d3.select(a);
    return "circle" === a.nodeName ? c = d.isStepType(b) ? !0 : d.isWithinCircle(a, 1.5 * d.pointSelectR(b)) : "path" === a.nodeName && (c = e.classed(h.bar) ? d.isWithinBar(a) : !0), c
    ...
    var f, g, h, i, j, k, n, o, p, q, r, s, t = this,
     ...
     w = "M",
     x = [];
    if (m(d)) for (f = 0; f < d.length; f++) x[f] = {}, x[f].start = l(d[f].start) ? a[0].x : t.isTimeSeries() ? t.parseDate(d[f].start) : d[f].start, x[f].end = l(d[f].end) ? a[a.length - 1].x : t.isTimeSeries() ? t.parseDate(d[f].end) : d[f].end;
    ...
    function (a, d, e, f) {
      ...
      else for (i = t.getScale(a[f - 1].x, a[f].x, t.isTimeSeries()), j = t.getScale(a[f - 1].value, a[f].value), k = b(a[f].x) - b(a[f - 1].x), n = c(a[f].value) - c(a[f - 1].value), o = Math.sqrt(Math.pow(k, 2) + Math.pow(n, 2)), p = 2 / o, q = 2 * p, g = p; 1 >= g; g += q) w += h(a[f - 1], a[f], g, p);
      v = a[f].x
    }
    return w
    ...
    var d = this;
    c && d.unexpandBars(), d.getBars(a).classed(h.EXPANDED, !0)
    ...
    var c, d = this.d3.select("body").append("svg").style("visibility", "hidden");
    return d.selectAll(".dummy").data([a]).enter().append("text").classed(b ? b : "", !0).text(a).each(function () {
    ...
    return f.config.axis_rotated ? (e = f.isBarType(b) ? 4 : 6, d = a[2][1] + e * (b.value < 0 ? -1 : 1)) : d = f.hasType("bar") ? (a[2][0] + a[0][0]) / 2 : a[0][0], null !== b.value ? d : d > f.width ? f.width - g.width : d
  }, f.getYForText = function (a, b, c) {
    var d, e = this,
     f = c.getBoundingClientRect();
    return d = e.config.axis_rotated ? (a[0][0] + a[2][0] + .6 * f.height) / 2 : a[2][1] + (b.value < 0 ? f.height : e.isBarType(b) ? -3 : -6), null !== b.value ? d : d < f.height ? f.height : d
    ...
    var c, d, e, f = this,
     g = f.main,
     i = f.config;
    f.grid.style("visibility", f.hasArcType() ? "hidden" : "visible"), g.select("line." + h.xgridFocus).style("visibility", "hidden"), i.grid_x_show && f.updateXGrid(), f.xgridLines = g.select("." + h.xgridLines).selectAll("." + h.xgridLine).data(i.grid_x_lines), c = f.xgridLines.enter().append("g").attr("class", function (a) {
    ...
    if ("year" === a) for (c = g.getXDomain(), d = c[0].getFullYear(), e = c[1].getFullYear(), f = d; e >= f; f++) i.push(new Date(f + "-01-01 00:00:00"));
    ...
    var c = this;
    a = c.mapToTargetIds(a), c.legend.selectAll("." + h.legendItem).classed(h.legendItemFocused, function (c) {
      return a.indexOf(c) >= 0 && b
    }).transition().duration(100).style("opacity", function (d) {
      var e = a.indexOf(d) >= 0 && b ? c.opacityForLegend : c.opacityForUnfocusedLegend;
      return e.call(c, c.d3.select(this))
    })
    ...
    function d(b, c, d) {
      function e(a, b) {
        b || (f = (o - B - n) / 2, z > f && (f = (o - n) / 2, B = 0, H++)), G[a] = H, F[H] = t.isLegendInset ? 10 : f, C[a] = B, B += n
      }
      var f, g, i = 0 === d,
       j = d === a.length - 1,
       k = t.getTextRect(b.textContent, h.legendItem),
       l = k.width + A + (j && !t.isLegendRight ? 0 : w),
       m = k.height + v,
       n = t.isLegendRight || t.isLegendInset ? m : l,
       o = t.isLegendRight || t.isLegendInset ? t.getLegendHeight() : t.getLegendWidth();
      return i && (B = 0, H = 0, x = 0, y = 0), u.legend_show && !t.isLegendToShow(c) ? void(D[c] = E[c] = G[c] = C[c] = 0) : (D[c] = l, E[c] = m, (!x || l >= x) && (x = l), (!y || m >= y) && (y = m), g = t.isLegendRight || t.isLegendInset ? y : x, void(u.legend_equally ? (Object.keys(D).forEach(function (a) {
        D[a] = x
      }), Object.keys(E).forEach(function (a) {
        E[a] = y
      }), f = (o - g * a.length) / 2, z > f ? (B = 0, H = 0, a.forEach(function (a) {
        e(a)
      })) : e(c, !0)) : e(c)))
    }
    var e, f, g, i, j, k, l, n, o, p, q, r, t = this,
     ...
     G = {},
     H = 0,
     I = t.legend.selectAll("." + h.legendItemFocused).size();
    b = b || {}, n = s(b, "withTransition", !0), o = s(b, "withTransitionForTransform", !0), t.isLegendRight ? (e = function (a) {
      ...
      u.legend_item_onclick ? u.legend_item_onclick.call(t, a) : t.d3.event.altKey ? (t.api.hide(), t.api.show(a)) : (t.api.toggle(a), t.isTargetToShow(a) ? t.api.focus(a) : t.api.revert())
    }).on("mouseover", function (a) {
      t.d3.select(this).classed(h.legendItemFocused, !0), !t.transiting && t.isTargetToShow(a) && t.api.focus(a), u.legend_item_onmouseover && u.legend_item_onmouseover.call(t, a)
    }).on("mouseout", function (a) {
      ...
      return t.isTargetToShow(a) ? !I || b.classed(h.legendItemFocused) ? t.opacityForLegend(b) : t.opacityForUnfocusedLegend(b) : t.legendOpacityForHidden
    }), t.updateLegendItemWidth(x), t.updateLegendItemHeight(y), t.updateLegendStep(H), t.updateSizes(), t.updateScales(), t.updateSvgSize(), t.transformAll(o, c)
  }, f.initAxis = function () {
    var a = this,
     b = a.config,
     c = a.main;
    ...
    })), j.tickFormat(c).tickValues(e), g.isCategorized() ? (j.tickCentered(h.axis_x_tick_centered), q(h.axis_x_tick_culling) && (h.axis_x_tick_culling = !1)) : j.tickOffset = function () {
      var a = this.scale(),
       b = g.getEdgeX(g.data.targets),
       c = a(b[1]) - a(b[0]),
    ...
    return d(this.d3, g).scale(a).orient(b).tickFormat(c).tickValues(e)
    ...
    var d, e, f, g, h, i, k, l = a;
    if (b) if (d = j(b) ? b() : b, 1 === d) l = [a[0]];
    else if (2 === d) l = [a[0], a[a.length - 1]];
    else if (d > 2) {
      for (g = d - 2, e = a[0], f = a[a.length - 1], h = (f - e) / (g + 1), l = [e], i = 0; g > i; i++) k = +e + h * (i + 1), l.push(c ? new Date(k) : k);
      l.push(f)
    }
    ...
    return d.transiting ? void(c = a.setInterval(function () {
      d.transiting || (a.clearInterval(c), d.expandArc(b))
    }, 10)) : (b = d.mapToTargetIds(b), void d.svg.selectAll(d.selectorTargets(b, "." + h.chartArc)).each(function (a) {
    ...
    var b = this;
    b.transiting || (a = b.mapToTargetIds(a), b.svg.selectAll(b.selectorTargets(a, "." + h.chartArc)).selectAll("path").transition().duration(50).attr("d", b.svgArc), b.svg.selectAll("." + h.arc).style("opacity", 1))
    ...
    b = e.select("." + h.chartArcs).selectAll("." + h.chartArc).data(d.pie(a)).attr("class", function (a) {
      return f(a) + i(a.data)
    }), c = b.enter().append("g").attr("class", f), c.append("g").attr("class", g), c.append("text").attr("dy", d.hasType("gauge") ? "-0.35em" : ".35em").style("opacity", 0).style("text-anchor", "middle").style("pointer-events", "none")
  }, f.initArc = function () {
    var a = this;
    ...
    var b = this,
     c = b.config;
    b.region.style("visibility", b.hasArcType() ? "hidden" : "visible"), b.mainRegion = b.main.select("." + h.regions).selectAll("." + h.region).data(c.regions), b.mainRegion.enter().append("g").attr("class", b.classRegion.bind(b)).append("rect").style("fill-opacity", 0), b.mainRegion.exit().transition().duration(a).style("opacity", 0).remove()
    ...
    k.hasArcType() || l.data_selection_enabled && (!l.zoom_enabled || k.zoom.altDomain) && l.data_selection_multiple && (b = k.dragStart[0], c = k.dragStart[1], d = a[0], e = a[1], f = Math.min(b, d), g = Math.max(b, d), i = l.data_selection_grouped ? k.margin.top : Math.min(c, e), j = l.data_selection_grouped ? k.height : Math.max(c, e), m.select("." + h.dragarea).attr("x", f).attr("y", i).attr("width", g - f).attr("height", j - i), m.selectAll("." + h.shapes).selectAll("." + h.shape).filter(function (a) {
      ...
      if (p.classed(h.circle)) c = 1 * p.attr("cx"), d = 1 * p.attr("cy"), m = k.togglePoint, s = c > f && g > c && d > i && j > d;
        ...
        o = u(this), c = o.x, d = o.y, e = o.width, l = o.height, m = k.togglePath, s = !(c > g || f > c + e || d > j || i > d + l)
      }
    ...
    var c, d = this;
    return "circle" === a.nodeName ? c = d.isStepType(b) ?
    function () {} : d.togglePoint : "path" === a.nodeName && (c = d.togglePath), c
  }, f.toggleShape = function (a, b, c) {
    var d = this,
     e = d.d3,
     f = d.config,
     g = e.select(a),
     i = g.classed(h.SELECTED),
    ...
    var a = this,
     b = a.config,
     c = j(b.axis_x_extent) ? b.axis_x_extent(a.getXDomain(a.data.targets)) : b.axis_x_extent;
    ...
    b.zoom = c.behavior.zoom().on("zoomstart", function () {
      ...
      a && e && b.zoom.translate(a), b.redrawForZoom.call(b), a = b.zoom.translate(), e = "wheel" === c.event.sourceEvent.type
      ...
      var a = p(b.x.orgDomain()) / p(b.orgXDomain),
  ...
  e.focus = function (a) {
    ...
    var b, c = this.internal;
    a = c.mapToTargetIds(a), b = c.svg.selectAll(c.selectorTargets(a.filter(c.isTargetToShow, c))), this.revert(), b.classed(h.focused, !1).classed(h.defocused, !0), c.hasArcType() && c.unexpandArc(a), c.toggleFocusLegend(a, !1), c.focusedTargetIds = c.focusedTargetIds.filter(function (b) {
      return a.indexOf(b) < 0
    }), c.defocusedTargetIds = a
  }, e.revert = function (a) {
    var b, c = this.internal;
    a = c.mapToTargetIds(a), b = c.svg.selectAll(c.selectorTargets(a)), b.classed(h.focused, !1).classed(h.defocused, !1), c.hasArcType() && c.unexpandArc(a), c.revertLegend(), c.focusedTargetIds = [], c.defocusedTargetIds = []
  }, e.show = function (a, b) {
    ...
    b = k.convertDataToTargets(c, !0), k.data.targets.forEach(function (a) {
      ...
      a.x < j && o++
    })) : m(a.length) && (o = a.length), n ? 1 === n && k.isTimeSeries() && (h = (f.values[f.values.length - 1].x - g.x) / 2, e = [new Date(+g.x - h), new Date(+g.x + h)], k.updateXDomain(null, !0, !0, !1, e)) : (h = k.isTimeSeries() ? f.values.length > 1 ? f.values[f.values.length - 1].x - g.x : g.x - k.getXDomain(k.data.targets)[0] : 1, e = [g.x - h, g.x], k.updateXDomain(null, !0, !0, !1, e)), k.updateTargets(k.data.targets), k.redraw({
      flow: {
        index: g.index,
        length: o,
    ...
    var b = this.internal.data.targets.filter(function (b) {
      return b.id === a
    });
    return b.length > 0 ? b[0] : null
  }, e.data.values = function (a) {
    var b = this.data(a);
    return b ? b.values.map(function (a) {
      return a.value
    }) : null
    ...
    var b = this.internal,
     c = b.config;
    return arguments.length ? ("object" == typeof a ? (i(a.x) && (c.axis_x_max = a.x), i(a.y) && (c.axis_y_max = a.y), i(a.y2) && (c.axis_y2_max = a.y2)) : c.axis_y_max = c.axis_y2_max = a, void b.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0
    })) : {
      x: c.axis_x_max,
    ...
    var b = this.internal,
     c = b.config;
    return arguments.length ? ("object" == typeof a ? (i(a.x) && (c.axis_x_min = a.x), i(a.y) && (c.axis_y_min = a.y), i(a.y2) && (c.axis_y2_min = a.y2)) : c.axis_y_min = c.axis_y2_min = a, void b.redraw({
      withUpdateOrgXDomain: !0,
      withUpdateXDomain: !0
    })) : {
      x: c.axis_x_min,
    ...
    return arguments.length ? (m(a.max) && this.axis.max(a.max), void(m(a.min) && this.axis.min(a.min))) : {
      max: this.axis.max(),
      min: this.axis.min()
    }
    ...
    a.mouse && (c = a.mouse), a.data ? d.isMultipleX() ? (c = [d.x(a.data.x), d.getYScale(a.data.id)(a.data.value)], b = null) : b = i(a.data.index) ? a.data.index : d.getIndexByX(a.data.x) : "undefined" != typeof a.x ? b = d.getIndexByX(a.x) : "undefined" != typeof a.index && (b = a.index), d.dispatchEvent("mouseover", b, c), d.dispatchEvent("mousemove", b, c)
